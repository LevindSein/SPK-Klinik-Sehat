    ...
    <div class="se-pre-con"></div>
        ...
        <div id="wrapper">
            ...
            <ul
                ...
                <!-- Nav Item - Dashboard -->
                <li class="nav-item"  >
                    <a class="nav-link" href="{{url('master/index')}}">
                ...
                <li class="nav-item">
                    ...
                    <div
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="{{url('nilai')}}">Data Nilai</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item"  >
                    <a class="nav-link" href="{{url('electre')}}">
                        <i class="fas fa-flask"></i>
                        <span>Keputusan Electre</span></a>
                </li>
